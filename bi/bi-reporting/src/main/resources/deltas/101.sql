...
-- So, Redshift is rubbish and won't recognise the view changes in 100. So, we need to cascade and recreate.

ALTER TABLE LOBBY_USER DROP COLUMN USER_ID CASCADE;
