...
and external_transaction_status in ('SUCCESS', 'AUTHORISED')
and et.cashier_name = cp.cashier_name
and et.cashier_name in ('FACEBOOK', 'GoogleCheckout', 'PayPal', 'PayPal-WPP', 'Paypal', 'iTunes', 'PayPal DG', 'Wirecard', 'Zong', 'WorldPay')
group by 1, 2, 3, 4;
