...
from
  external_transaction et, player_definition pd, player_referrer pr
where
  et.account_id = pd.account_id
and
  pd.player_id = pr.player_id
and
  external_transaction_status = 'SUCCESS';