...
begin
    ...
    from tmp_app_request_template t, (select 'FACEBOOK' channel_type union select 'IOS' channel_type union select 'GOOGLE_CLOUD_MESSAGING_FOR_ANDROID' channel_type) tc
