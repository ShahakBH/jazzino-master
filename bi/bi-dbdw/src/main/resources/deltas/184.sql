...
begin
  ...
  declare appRequestIdCursor cursor for select id from APP_REQUEST where sent is not null and (expiry_dt is null or expiry_dt < date_sub(now(), interval 1 day));
