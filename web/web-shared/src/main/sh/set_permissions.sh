...
add_or_update_user flash readonly
add_or_update_user pat p0stm4n
add_or_update_user ping ping
add_or_update_user worker w0rk3r%

rabbit set_permissions ping ping ping ping

add_vhost $VHOST
rabbit set_permissions \-p $VHOST flash '^$' '^$' player
rabbit set_permissions \-p $VHOST pat player player player
