...
@Configuration
public class OpenGraphServiceConfiguration {
    ...
    @Bean
    public QueuePublishingService<OpenGraphCredentialsMessage> openGraphCredentialsService(
        ...
        return new SafeQueuePublishingEventService<OpenGraphCredentialsMessage>(publisher);
    }
