package com.yazino.platform.event.table;
...
public class TableEventServiceConfiguration {
    ...
    @Bean
    public QueuePublishingService<TableEvent> tableEventQueuePublishingService(
        ...
        return new SafeQueuePublishingEventService<TableEvent>(publisher);
    }
}
