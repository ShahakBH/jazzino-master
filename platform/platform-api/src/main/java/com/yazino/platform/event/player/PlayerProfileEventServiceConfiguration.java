...
public class PlayerProfileEventServiceConfiguration {
    ...
    @Bean
    public QueuePublishingService<PlayerProfileEvent> playerProfileEventQueuePublishingService(
        ...
        return new SafeQueuePublishingEventService<PlayerProfileEvent>(publisher);
    }
}
