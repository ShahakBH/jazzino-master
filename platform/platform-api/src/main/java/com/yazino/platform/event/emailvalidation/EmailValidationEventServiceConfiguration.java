package com.yazino.platform.event.emailvalidation;
...
public class EmailValidationEventServiceConfiguration {
    ...
    @Bean
    public QueuePublishingService<EmailValidationEvent> emailValidationEventQueuePublishingService(
        ...
        return new SafeQueuePublishingEventService<EmailValidationEvent>(publisher);
    }
}
