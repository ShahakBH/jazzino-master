package com.yazino.platform.event.invitation;
...
public class InvitationEventServiceConfiguration {
    ...
    @Bean
    public QueuePublishingService<InvitationEvent> invitationEventQueuePublishingService(
        ...
        return new SafeQueuePublishingEventService<InvitationEvent>(publisher);
    }
}
