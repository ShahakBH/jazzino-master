...
public class ThresholdEventAccumulator implements Accumulator {
    private static final String NAME = "thresholdEvent";

    private final AchievementManager achievementManager;

    @Autowired
    public ThresholdEventAccumulator(@Qualifier("achievementManager") final AchievementManager achievementManager) {
